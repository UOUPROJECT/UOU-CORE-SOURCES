...
#define PACKAGE_BUGREPORT "https://github.com/UOUORG/UOU-CORE/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "UOU Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "UOU Core 6.0.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "UOU"
