    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText       = tr("UOU Core");
    QString versionText     = QString("Version %1").arg(QString::fromStdString(FormatFullVersion()));
    QString copyrightText   = QChar(0xA9)+QString("2009-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Bitcoin developers"));
    QString copyrightText2  = QChar(0xA9)+QString("2017 ").arg(COPYRIGHT_YEAR) + QString(tr("The UOU developers"));

    const char *inspirationals[] = {
        "Do you even UOU?",
        "Broadcast to the world right now.",
        "The nut is the smallest unit of UOU.",
        "There are 100,000,000 nuts in one UOU.",
        "Help! I'm being UOU against my will.",
        "Plan for profit. Step 1:UOU, Step 2:UOU, Step 3:UOU",
        "UOU your horses.",
        "Let us UOU each other.",
        "What would Jesus UOU?",
        "Turn on, tune in, UOU out.",
        "Winter is Coming.",
        "Ask not for a lighter burden, but for broader sUOUers.",
        "Keep Calm and UOU On.",
        "Welcome to UOU California.",
        "UOU - right:UOU"
    };

    srand(time(NULL)+clock());
    QString inspirationalText  = QString(inspirationals[rand() % 15]);
    QString authorText = QString("                        - Martin Sakamoto");
