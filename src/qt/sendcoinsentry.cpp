...
void SendCoinsEntry::clear()
{
    ...
    if(!isPipeMan){
        ...
        ui->payToLabel->setText("Owner Address:");
        ui->labellLabel->setText("Pipe Domain");
        //ui->labellLabel->setPlaceholdText("");
        ui->payAmount->setValue(500*COIN);
...
void SendCoinsEntry::setAsPipeMan(){
    isPipeMan=true;
